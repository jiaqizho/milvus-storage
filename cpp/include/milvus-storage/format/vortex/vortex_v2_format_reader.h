...
class VortexV2FormatReader final : public FormatReader, public std::enable_shared_from_this<VortexV2FormatReader> {
  public:
  VortexV2FormatReader(const std::shared_ptr<arrow::fs::FileSystem>& fs,
